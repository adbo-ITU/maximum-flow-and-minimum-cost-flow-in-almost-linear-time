...
@pytest.mark.slow
def test_flow_random_dag_134_edges():
    graph, s, t = parse_input(INPUT_134_EDGES)
    edges, capacities, _ = make_edges_and_capacities(graph)
    mf, flows = max_flow_with_guess(edges, capacities, s=s, t=t, optimal_flow=121)
    assert_valid_solution(graph, s, t, flows, mf)
...
def test_flow_random_dag_517_edges():
    ...
    edges, capacities, _ = make_edges_and_capacities(graph)
    mf, flows = max_flow_with_guess(edges, capacities, s=s, t=t, optimal_flow=247)
    assert_valid_solution(graph, s, t, flows, mf)
