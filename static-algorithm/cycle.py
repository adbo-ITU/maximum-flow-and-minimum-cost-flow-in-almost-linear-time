...
def find_min_ratio_cycle(I: MinCostFlow, f: np.ndarray):
    ...
    for cycle in nx.simple_cycles(G):
        ...
        for dir in [1, -1]:
            ...
            if ratio < min_ratio:
                min_ratio = ratio
                min_ratio_circulation = circulation

    # TODO: scale the circulation to maximise change in flow?
    return (min_ratio, min_ratio_circulation)
